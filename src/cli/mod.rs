...
pub fn start_cli(matches: ArgMatches) {
    ...
    match matches.subcommand() {
        ...
        Some(("desktop", sub_matches)) => match sub_matches.subcommand() {
            ...
            Some(("new-skeleton", sub_sub_matches)) => {
                commands::desktop::newskeleton::run(sub_sub_matches)
            }
            ...
            Some(("set-default-theme", sub_sub_matches)) => {
                commands::desktop::setdefault::run(sub_sub_matches)
            }
        ...
        Some(("theme", sub_matches)) => match sub_matches.subcommand() {
            ...
            Some(("new-skeleton", sub_sub_matches)) => {
                commands::theme::newskeleton::run(sub_sub_matches)
            }
        ...
        Some(("pattern", sub_matches)) => match sub_matches.subcommand() {
            ...
            Some(("enable", sub_sub_matches)) => {
                commands::pattern::manage::run(sub_sub_matches, Action::Enable)
            }
            Some(("disable", sub_sub_matches)) => {
                commands::pattern::manage::run(sub_sub_matches, Action::Disable)
            }
            Some(("toggle", sub_sub_matches)) => {
                commands::pattern::manage::run(sub_sub_matches, Action::Toggle)
            }
        ...
        Some(("extra", sub_matches)) => match sub_matches.subcommand() {
            ...
            Some(("enable", sub_sub_matches)) => {
                commands::extra::manage::run(sub_sub_matches, Action::Enable)
            }
            Some(("disable", sub_sub_matches)) => {
                commands::extra::manage::run(sub_sub_matches, Action::Disable)
            }
            Some(("toggle", sub_sub_matches)) => {
                commands::extra::manage::run(sub_sub_matches, Action::Toggle)
            }
            _ => (),
        },
        ...
        Some(("fav", sub_matches)) => match sub_matches.subcommand() {
            ...
            Some(("add", sub_sub_matches)) => {
                commands::fav::manage::run(sub_sub_matches, Action::Enable)
            }
            Some(("remove", sub_sub_matches)) => {
                commands::fav::manage::run(sub_sub_matches, Action::Disable)
            }
            Some(("toggle", sub_sub_matches)) => {
                commands::fav::manage::run(sub_sub_matches, Action::Toggle)
            }
            _ => (),
        },
